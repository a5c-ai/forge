      ...
      {repo ? (
        <div className="grid gap-1">
          ...
          <div className="text-xs text-zinc-500">
            Configure via <code className="rounded bg-zinc-800 px-1">A5C_REPO</code> and <code className="rounded bg-zinc-800 px-1">A5C_INBOX_REFS</code>{" "}
            and restart the UI process.
          </div>
          {remoteUrl ? (
            <div className="text-xs text-zinc-500">
